...
function onDark() {
  el.innerHTML =
    '<div title="Change to Light Mode" style="margin-left: 14px; margin-right: 14px; min-width: 0px;"><div role="button" tabindex="0" style="user-select: none; transition: background 120ms ease-in 0s; cursor: pointer; border-radius: 44px;"><div style="display: flex; flex-shrink: 0; height: 14px; width: 26px; padding: 2px; box-sizing: content-box; border-radius: 44px; border-style: solid; border-width: 0.1em; border-color: #D4D4D4; transition: background 200ms ease 0s, box-shadow 200ms ease 0s;"><div style="width: 14px; height: 14px; border-radius: 44px; transition: transform 200ms ease-out 0s, background 200ms ease-out 0s; transform: translateX(12px) translateY(0px); content: url(&quot;https://cdn.cloak.ist/toggle_sun.svg&quot;);"></div></div></div></div>'
...
function onLight() {
  el.innerHTML =
    '<div title="Change to Dark Mode" style="margin-left: 14px; margin-right: 14px; min-width: 0px;"><div role="button" tabindex="0" style="user-select: none; transition: background 120ms ease-in 0s; cursor: pointer; border-radius: 44px;"><div style="display: flex; flex-shrink: 0; height: 14px; width: 26px; padding: 2px; box-sizing: content-box; border-radius: 44px; border-style: solid; border-width: 0.1em; border-color: #6D6C68; transition: background 200ms ease 0s, box-shadow 200ms ease 0s;"><div style="width: 14px; height: 14px; border-radius: 44px; transition: transform 200ms ease-out 0s, background 200ms ease-out 0s; transform: translateX(0px) translateY(0px); content: url(&quot;https://cdn.cloak.ist/toggle_moon.svg&quot;);"></div></div></div></div>'
...
window.XMLHttpRequest.prototype.open = function () {
  arguments[1] = arguments[1].replace(domain, 'www.notion.so')

  if (arguments[1].indexOf('msgstore.www.notion.so') > -1) {
    return
  }
